...
write(*,"(A)") "          (cond"
write(*,"(A)") "           (is-rest? empty-stencil)"
write(*,"(A)") "           ((ly:grob? beam)"
...
write(*,"(A)") "                  #:override '(thickness . 1.7)"
write(*,"(A)") "                  #:draw-line"
...
write(11,"(A)") "          (cond"
write(11,"(A)") "           (is-rest? empty-stencil)"
write(11,"(A)") "           ((ly:grob? beam)"
